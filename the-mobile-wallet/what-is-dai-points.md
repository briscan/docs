...
DAI point are created so users can have an easy way to explore the functionality of the BRI wallet. The points were created using the Studio and issued on the BRI blockchain. They are exchangeble to DAI trough the bridge. 100 DAI point are worth 1 DAI. 
