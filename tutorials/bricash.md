---
description: Security practices for keeping your bri.cash wallet secured
---

# bri.cash wallet security guidelines

## Useful Guidelines on Keeping Your bri.cash Wallet Secured 🔐

![](../.gitbook/assets/bri-cash-card-image-1200x628-.png)

###  **1. Start with a Secure Foundation for Your Wallet**

Make sure your device is free of any malware and never install [**bri.cash**](https://bri.cash/) ****onto a rooted device. To make sure you are always using an authentic version of bri.cash wallet, you should download the app exclusively from the links provided on our [**website**](https://bri.cash/).
...
{% hint style="info" %}
**Backup your recovery phrase in bri.cash wallet by navigating to 'Account' -&gt; 'Protect your wallet' -&gt; 'Back up' .**
{% endhint %}
...
To make sure only you have access to your BRI Cash mobile app, make sure to add another layer of authentication such as Passcode or Touch/Face ID to access your funds on your BRI Cash wallet. This prevents any bad actors accessing your wallet in case you lose your mobile device or leave it unsafe .  
****
