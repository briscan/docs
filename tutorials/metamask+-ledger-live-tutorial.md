...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on BRI after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “BRI network” and perform the transactions on BRI network through your Ledger device.

Note: To learn how to add BRI RPC follow [this link.](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask)
