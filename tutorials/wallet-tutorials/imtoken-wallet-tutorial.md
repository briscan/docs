...
Below tutorial will help you understand how to add BRI network RPC on imToken through chainlist.org and transfer/receive tokens on bri network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “BRI” on the list of EVM networks. Click on “Add to imToken” next to BRI Mainnet and “Approve” the details of BRI RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added BRI network RPC on imToken wallet. You can now send/receive BRI network assets on imToken wallet.  
