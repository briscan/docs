...
description: >-
  ...
  the BRI Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the BRI network on your Metamask wallet before creating the community. Learn how to add BRI network to Metamask using [this](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask) tutorial.

Navigate to https://studio.briscan.io/ and click on **“Login”** at the right hand top corner as shown below. Use your Gmail account to Sign in.
...
You can also view both your ETH balance and BRI balance by clicking on “BRI network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on BRI”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to BRI network.
...
It's been a long road, but you are finally on the last step! To be able to make easy mobile transactions using your community, **download the BRI wallet app** on the [App Store](https://apps.apple.com/il/app/bri-wallet/id1491783654) or [Google Play](https://play.google.com/store/apps/details?id=io.bri.bricash).
