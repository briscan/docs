...
We will learn how to connect Ledger to Metamask and use it on BRI network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “BRI network” and perform the transactions on BRI network through your Ledger device.

Note: To learn how to add BRI network RPC follow [this link.](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask)
