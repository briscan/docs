---
description: >-
  Steps to transfer/wrap ZED20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with ZED20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/BRI explorer to relay the tokens. This tutorial is applicable only for ZED20 tokens other than BRI. Do not use this tutorial to transfer BRI.** 
...
In the below example we will consider USDT \(ZED20\) and learn how to wrap USDT to Fusenet and relay it back to ZED20.
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your BRI address and have been swapped from Ethereum mainnet to Fusenet.

Now let’s learn how to transfer the wrapped ZED20 tokens on Fusenet back to Ethereum mainnet.
...
https://briscan.io/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is BRI network. If you have not added BRI network please follow the instructions [here](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask).
...
[https://briscan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://briscan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on BRI network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as BRI is PoS network. After sometime you should be able to see the successful transfer of the token on your ZED20 address.
