...
Any entity that is holding the BRI token can run a node that approves transaction in the network and in doing so receive rewards in the form of BRI token (BRI).
...
You can delegate you BRI token to a validator of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their BRI token to a validator to earn rewards through the validator.
