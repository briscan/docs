...
BRI chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://briscan.io/address/0xD4cFA3b4686B8025e3E2aA2d115dBf120B088469) with the following params:
...
Some other useful functions on the [voting contract](https://briscan.io/address/0xD4cFA3b4686B8025e3E2aA2d115dBf120B088469) are:
