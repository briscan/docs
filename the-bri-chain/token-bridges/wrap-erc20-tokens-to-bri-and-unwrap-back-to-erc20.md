---
description: Steps to transfer/wrap ZED20 tokens from Ethereum to Fusenet
---

# Bridge for ZED20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/BRI explorer to relay the tokens.
