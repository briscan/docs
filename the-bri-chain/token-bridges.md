...
1. BRI Bridge:  ****The bridge, based on POA's bridge implementation, is used to transfer BRI tokens between the BRI chain and the Ethereum network.
2. ZED20 token bridge: This bridge is used to transfer ZED20 tokens into BRI chain and back. Please not that BRI bridge is not supposed to be used to transfer  . 
...
**Transfering from Fusenet to Ethereum mainnet** - Send your Native BRI tokens to the BRI chain bridge for them to be released from the mainnet bridge and be avaliable in your Mainnet wallet. 
