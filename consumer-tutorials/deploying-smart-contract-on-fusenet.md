...
BRI is an EVM compatible network, every tool for Ethereum can be used for the BRI network too.
...
Since we interact with remix using Metamask, you need to change the network to BRI network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask) to do that.

You need to have a small balance of BRI on the Fusenet wallet you are using which will be used as Gas for the transactions.
