---
description: This tutorial will explain how to delegate/stake/unstake your BRI.
---

# Staking tutorial

Note: You can only stake BRI which is on BRI network. Please make sure you have changed into BRI network in Metamask while doing any transactions on staking UI. 

How to Stake BRI:

**Step 1:**

Navigate to staking.briscan.io and login to your wallet through metamask. Make sure you are on BRI network. If you are not please follow the instructions [**here**](https://docs.briscan.io/the-bri-studio/getting-started/how-to-add-bri-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of BRI you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
