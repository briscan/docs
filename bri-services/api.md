...
## bri-studio-backend v0.1.0

The BRI Studio REST API for accessing the data and the services of the BRI network in a simple way. You can use this API to query and interact with the objects of the BRI network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and BRI network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(BRI\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the BRI network |
...
| homeBridgeAddress | `String` | Bridge address on the BRI network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the BRI network |
...
Community is a set of contracts and services. Members of the community are users of the BRI network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the BRI network |
| homeTokenAddress | `String` | Address of the community token on the BRI network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the BRI network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the BRI network |
...
Entity is an account on the BRI network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on BRI network |
...
Tokens are compatible with the ZED20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/bri |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/bri |
| page | `Number` | Page number for pagination |
